...
import { FileText, Link as LinkIcon, Upload, AlignLeft, Trash2, ArrowUpDown, Building2 } from 'lucide-react'
        ...
        <div className="mb-6 flex-shrink-0">
          ...
          {memberships.length > 0 && (
            <div className="mt-2 flex items-center gap-2 flex-wrap">
              ...
              {memberships.map(m => (
                <Badge key={m.org_id} variant="outline" className="text-[10px] gap-1 font-normal">
                  <Building2 className="h-2.5 w-2.5" />
                  {m.org_name}
                </Badge>
              ))}
