export const zhCN = {
  ...
  auth: {
    loginTitle: "欢迎回来",
    loginDesc: "登录您的 Open Notebook 账号",
    passwordPlaceholder: "密码",
    signingIn: "正在登录...",
    signIn: "登录",
    connectErrorHint: "无法连接到服务器。请检查 API 是否正在运行。",
    registerTitle: "创建账号",
    registerDesc: "加入 Open Notebook，开始您的研究",
    register: "创建账号",
    registering: "正在创建...",
    username: "用户名",
    ...
    orgSection: "组织",
    orgSectionDesc: "加入已有组织或创建新组织",
    joinExistingOrg: "加入已有组织",
    createNewOrg: "创建新组织",
    noOrg: "无组织（独立用户）",
    orgName: "组织名称",
    orgNamePlaceholder: "我的研究团队",
    selectOrg: "选择组织...",
    alreadyHaveAccount: "已有账号？",
    dontHaveAccount: "没有账号？",
    pendingApproval: "账号待审核",
    pendingApprovalDesc: "您的账号已创建，正在等待管理员审核。审核通过后您将可以登录。",
    ...
    makeUser: "设为普通用户",
    deleteUser: "删除用户",
    deleteUserConfirm: "确定要删除该用户吗？此操作不可撤销。",
    userApproved: "用户审核通过",
    userSuspended: "用户已封禁",
    userDeleted: "用户已删除",
    roleUpdated: "角色已更新",
    ...
    editOrg: "编辑组织",
    deleteOrg: "删除组织",
    deleteOrgConfirm: "确定要删除该组织吗？",
    orgNameLabel: "名称",
    orgDescLabel: "描述",
    pendingUsers: "待审核用户",
    activeUsers: "活跃用户",
    suspendedUsers: "已封禁用户",
    noUsers: "暂无用户",
    noOrgs: "暂无组织",
    statusPending: "待审核",
    statusActive: "已激活",
  ...
  agents: {
    pageDescription: "独立智能体工作台：选择一个笔记本后，可直接与其知识内容进行对话。",
    selectNotebook: "选择笔记本",
    selectNotebookPlaceholder: "请选择一个笔记本",
    emptyState: "请选择一个笔记本以启用智能体对话。",
    createAgent: "创建智能体",
    newAgentPlaceholder: "输入智能体名称（例如：产品研究助理）",
    defaultAgentDescription: "由智能体工作台创建，用于资料管理与对话。",
    visibilityScope: "组织可见范围（用于隔离）",
    published: "已发布",
    unpublished: "未发布",
    publish: "发布",
    unpublish: "取消发布",
