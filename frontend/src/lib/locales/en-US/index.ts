export const enUS = {
  ...
  auth: {
    ...
    loginDesc: "Sign in to your Open Notebook account",
    ...
    registerDesc: "Join Open Notebook and start your research",
    ...
    orgSectionDesc: "Join an existing organization or create a new one",
    joinExistingOrg: "Join existing organization",
    createNewOrg: "Create new organization",
    noOrg: "No organization (standalone)",
    orgName: "Organization Name",
    orgNamePlaceholder: "My Research Team",
    selectOrg: "Select organization...",
    alreadyHaveAccount: "Already have an account?",
    dontHaveAccount: "Don't have an account?",
    pendingApproval: "Account Pending Approval",
    pendingApprovalDesc: "Your account has been created and is awaiting administrator approval. You will be notified once approved.",
    ...
    orgAdmin: "Org Admin",
    addUser: "Add User",
    addUserDesc: "Create a new user account directly (auto-approved)",
  ...
  agents: {
    pageDescription: "A dedicated agent workspace: choose a notebook and chat directly with its knowledge context.",
    selectNotebook: "Select Notebook",
    selectNotebookPlaceholder: "Choose a notebook",
    emptyState: "Select a notebook to start an agent chat.",
    createAgent: "Create Agent",
    newAgentPlaceholder: "Enter agent name (e.g. Product Research Assistant)",
    defaultAgentDescription: "Created from the agent workspace for source management and chat.",
    visibilityScope: "Organization visibility scope (isolation)",
    published: "Published",
    unpublished: "Draft",
    publish: "Publish",
    unpublish: "Unpublish",
